...
function withStateSlice(Comp, slice) {
  ...
  function Wrapper(props, ref) {
    console.log('render state slice');
...
function DogNameInput() {
  ...
  return (
    <form onSubmit={(e) => e.preventDefault()}>
      ...
      <input value={state.dogName} onChange={handleChange} id="dogName" placeholder="Toto" />
      {state.dogName ? (
        <div>
          <strong>{state.dogName}</strong>, I've a feeling we're not in Kansas anymore
        </div>
      ) : null}
    </form>
  );
